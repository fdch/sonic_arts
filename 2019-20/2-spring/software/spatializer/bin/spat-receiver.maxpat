...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 871.0, 193.0, 141.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 526.0, 129.0, 225.0, 60.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 477.0, 54.0, 200.0, 35.0 ],
...
,
					"patching_rect" : [ 328.0, 185.0, 71.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 457.0, 185.0, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -360.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 243.0, 97.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 327.0, 273.0, 56.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 327.0, 303.0, 267.0, 33.0 ],
					"presentation_linecount" : 4,
					"text" : "/source/number 1, /source/1/az -30, /source/*/constraint/circular 1, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 327.0, 413.5, 72.0, 21.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 151.5, 398.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 151.5, 417.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.0, 141.0, 34.0, 22.0 ],
					"text" : "pak"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.0, 61.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 262.0, 3.0, 384.0, 130.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 168.5, 252.0, 24.0, 24.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 509.0, 152.0, 33.0, 22.0 ],
									"text" : "* 0.4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 497.0, 92.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 101.0, 80.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 347.0, 372.0, 100.0, 22.0 ],
									"text" : "lores~ 80"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 331.0, 453.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 315.0, 417.0, 40.0, 22.0 ],
									"text" : "*~ 0.4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 220.0, 410.0, 29.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 331.0, 328.0, 66.0, 22.0 ],
									"text" : "phasor~ -3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 197.0, 214.0, 29.5, 22.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 389.0, 147.0, 30.0, 22.0 ],
									"text" : "* 15"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 214.0, 32.0, 22.0 ],
									"text" : "mtof"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 88.0, 338.0, 34.0, 22.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 302.0, 57.0, 22.0 ],
									"text" : "pack f 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 401.0, 225.0, 34.0, 22.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 395.0, 189.0, 57.0, 22.0 ],
									"text" : "pack f 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 342.0, 274.0, 29.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 287.0, 208.0, 43.0, 22.0 ],
									"text" : "cycle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 203.0, 379.0, 43.0, 22.0 ],
									"text" : "cycle~"
								}
...
,
					"patching_rect" : [ 136.5, 288.0, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 185.0, 153.0, 22.0 ],
					"text" : "/source/1 $1 $2 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 82.0, 319.0, 158.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.binaural~ @sources 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 82.0, 27.0, 128.0, 22.0 ],
					"text" : "route /slider-0 /slider-1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 3.0, 97.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-34::obj-65" : [ "live.dial[12]", "yaw", 0 ],
			"obj-29::obj-16" : [ "live.text[1]", "live.text", 0 ],
			"obj-34::obj-6" : [ "live.dial[13]", "roll", 0 ],
			"obj-34::obj-9" : [ "live.dial[14]", "pitch", 0 ],
			"obj-34::obj-10" : [ "live.dial[15]", "yaw", 0 ],
			"obj-29::obj-607" : [ "live.button[1]", "live.button", 0 ],
			"obj-29::obj-11" : [ "live.text[4]", "live.text", 0 ],
			"obj-34::obj-56" : [ "live.menu[6]", "live.menu[3]", 0 ],
			"obj-34::obj-64" : [ "live.dial[11]", "pitch", 0 ],
			"obj-23" : [ "live.dial[17]", "azim", 0 ],
			"obj-34::obj-7" : [ "live.dial[16]", "yaw", 0 ],
			"obj-34::obj-63" : [ "live.dial[8]", "roll", 0 ],
			"parameterbanks" : 			{
